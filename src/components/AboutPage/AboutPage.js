...
export default function AboutPage() {
  ...
  -52 75 -200 -12z" className="svg-elem-1"></path>
  ...
  133 -14 0 -119 -54 -235 -121z" className="svg-elem-2"></path>
  ...
  145 95 111 143 -25 36 -67 27 -176 -36z" className="svg-elem-3"></path>
  ...
  -115 67 c-75 45 -125 68 -145 67 -20 0 -100 -41 -232 -117z" className="svg-elem-4"></path>
  ...
  22 22 22 164 0 212 -15 221 -195 115z" className="svg-elem-5"></path>
  ...
  -23 46 -67 38 -192 -36z" className="svg-elem-6"></path>
  ...
  325 -18 340 -10 10 -27 17 -38 17 -10 0 -71 -30 -136 -66z" className="svg-elem-7"></path>
  ...
  -58 15 -77 -4z" className="svg-elem-8"></path>
              </g>
            </svg>
          </div>
          <div className="cvVide"></div>
        </div>

        <div className="cvRow">
          <div className="cvFormation">
            <h2>Formation</h2>

            <div className="cvItem">
              <h3>IIM</h3>
              <h4>Mastère chef de projet digital</h4>
              <p>2020 - 2025</p>
            </div>

            <div className="cvItem">
              <h3>Lycée Albert Camus</h3>
              <h4>Bac ES</h4>
              <p>2016 - 2019</p>
            </div>
          </div>
        ...
        <div className="cvRow">
          <div className="cvExperience">
            ...
            <div className="cvItem">
              <h3>Développeur Web JavaScript/React</h3>
              <h4>TRYGR.</h4>
              <p>Mai 2022 - Aujourd'hui</p>
              <br />
              <p>Création de diverses fonctionnalités et d'une refonte graphique</p>
            </div>
            <div className="cvItem">
              <h3>Réalisation du meilleur projet de groupe</h3>
              <h4>IIM</h4>
              <p>Septembre 2021 - Janvier 2021</p>
              <br />
              <p>Création d'un dashboard de gestion de données avec Laravel et Tailwind</p>
            </div>

          </div>
          <div className="cvHobby">
            <h2>Hobby</h2>
